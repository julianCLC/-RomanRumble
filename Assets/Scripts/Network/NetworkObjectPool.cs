...
public class NetworkObjectPool : NetworkBehaviour
{
    ...
    Dictionary<GameObject, int> m_SpawnedObjects = new Dictionary<GameObject, int>();
    ...
    /// <summary>
    /// Return count of prefabs that have been spawned
    /// </summary>
    /// <param name="prefab"></param>
    /// <returns></returns>
    public int GetCurrentPrefabSpawnedCount(GameObject prefab){
        return m_SpawnedObjects[prefab];
    }
